...
$_SESSION['siteurl'] = $ayar['siteurl'];
$_SESSION['mailkota'] = $ayar['mailkota'];
$_SESSION['kullanici'] = $ayar['kullanici'];
$_SESSION['alanadi'] = $ayar['alanadi'];
    ...
    if ($indirim == '1') {
        if ($urunkdv > '0') { ?>
            ...
            <span class="old-price">
                <?php echo $eskifiyatz = fiyatgoster(KdvDahil($urunfiyat, $system['kdv'])); ?></span>&nbsp;&nbsp;
