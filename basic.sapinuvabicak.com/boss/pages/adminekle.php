                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <select class="form-control" name="departman" required>
                                                ...
                                                <?php $pr = $ozy->query("select * from departman where durum=1 ORDER BY adi ASC")->fetchAll(PDO::FETCH_ASSOC);
                                                foreach ($pr as $tr) { ?>
                                                    <option value="<?php echo $tr['id']; ?>" <?php echo (isset($sayfam) && $sayfam['departman'] == $tr['id']) ? 'selected' : ''; ?>>
                                                        <?php echo $tr['adi']; ?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                    </div>
