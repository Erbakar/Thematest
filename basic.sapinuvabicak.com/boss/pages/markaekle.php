...
if ($_GET['duzenle']) {
    ...
    $sayfam = $ozy->query("select * from markalar where id=$id")->fetch(PDO::FETCH_ASSOC);
    ...
    if (isset($_POST['guncelle'])) {
        ...
        if (!empty($_FILES['resim']['name'])) {
            if ($restip != 'image/jpeg'  && $restip != 'image/png' && $uzanti != '.jpg' && $uzanti != '.png' && $uzanti != '.jpeg') {
                ...
                $id = $_GET['duzenle'];
                $stmt = $ozy->prepare("UPDATE markalar SET adi = ?, seo = ?, link = ?, durum = ?, sira = ?, resim = ? WHERE id = ?");
                ...
                if ($result2) {
                    ...
                    echo '<meta http-equiv="refresh" content="1; url=' . $url . '/boss/marka/duzenle/' . $id . '">';
                } else {
            ...
            $id = $_GET['duzenle'];
            $stmt = $ozy->prepare("UPDATE markalar SET adi = ?, seo = ?, link = ?, durum = ?, sira = ? WHERE id = ?");
    ...
    if (isset($_POST['kaydet']) && $markasayisi < $Paket_adi['markalimit']) {
        ...
        if (empty($_FILES['resim']['name'])) {
            ...
            $stmt = $ozy->prepare("INSERT INTO markalar (adi, seo, durum, link, tarih, resim) 
   VALUES (?,?,?,?,?,?)");
            ...
            if ($result2) {
                ...
                echo '<meta http-equiv="refresh" content="1; url=tum-markalar">';
            } else {
   ...
   VALUES (?,?,?,?,?,?)");
        ...
        echo '<script type="text/javascript">$(document).ready(function(){toastr["error"]("Limit doldu.", "Başarısız");});</script>';
    }
            ...
            <div class="row align-items-center">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-right">
                        ...
                        <li class="breadcrumb-item active">Marka
                            <?php if ($_GET['duzenle']) { ?>
                                Düzenle
                            <?php } else { ?>
                                Ekle
                    ...
                    <div class="card m-b-30">
                        <div class="card-body">
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane active p-3" id="home-1" role="tabpanel">
                                    <div class="form-group row">
                                        <label for="example-text-input" class="col-sm-2 col-form-label">Marka Seo Linki </br>(Boş bırakırsanız otomatik seo link oluşacaktır)</label>
                                        <div class="col-sm-10">
                                    ...
                                    <div class="form-group row">
                                        <label for="example-text-input" class="col-sm-2 col-form-label">Marka Sırası </br>(En başa almak için en yüksek sayıyı veriniz)</label>
                                        <div class="col-sm-10">
                                    ...
                                    <div class="form-group row">
                                        <label for="example-text-input" class="col-sm-2 col-form-label">Marka URL</label>
                                        <div class="col-sm-10">
                                            ...
                                            <div class="controls">
                                                <div class="fileupload fileupload-new" data-provides="fileupload">
                                                    ...
                                                    <div class="fileupload-new thumbnail fileupload-preview thumbnail" style="width: 200px; height: 150px;">
                                                        ...
                                                        <?php if ($_GET['duzenle']) { ?>
                                                            <img src="../resimler/markalar/<?php echo $sayfam['resim']; ?>" style="width: 200px; height: 200px;" alt="" />
                                                        <?php } else { ?>
                            ...
                            <?php } else {
                                ...
                                $markasayisi = count($markalar);
                                if ($markasayisi < $Paket_adi['markalimit']) {
                                    echo '<button type="submit" name="kaydet" class="btn btn-primary btn-lg btn-block waves-effect waves-light">Kaydet</button>';
                                } else {
                                    echo '<button type="submit" name="kaydet" class="btn btn-primary btn-lg btn-block waves-effect waves-light" disabled>Limit Doldu</button>';
                                }
                            } ?>
