        ...
        <div class="container-fluid">
            ...
            <div class="page-title-box">
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <h4 class="page-title">İade Edilen Siparişler</h4>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-right">
                            <li class="breadcrumb-item"><a href="index.html">Anasayfa</a></li>
                           
                            <li class="breadcrumb-item active">İade Edilen Siparişler</li>
                        </ol>
                    </div>
                </div>
                <!-- end row -->
                ...
                <div class="col-12">
                    <div class="card m-b-30">
                        <div class="card-body">
	                       ...
	                       <?php $pr = $ozy->query("select * from siparis where durum='İade Edildi' ORDER BY id DESC")->fetchAll(PDO::FETCH_ASSOC);
                           foreach ($pr as $tr) {?>	
