    ...
    <div class="container-fluid">
        ...
        <div class="page-title-box">
            <div class="row align-items-center">
                <div class="col-sm-6">
                    <h4 class="page-title">Yeni Siparişler</h4>
                </div>
                <div class="col-sm-6">
                    ...
                    <div class="card-body">
                        <table data-order='[[ 0, "desc" ]]' id="datatable"
                            ...
                            <tbody>
                                ...
                                <?php $pr = $ozy->query("select * from siparis where durum='Ödeme Bekleniyor' or durum='Sipariş Onaylandı' ORDER BY id desc")->fetchAll(PDO::FETCH_ASSOC);
                                foreach ($pr as $tr) { ?>
                                    ...
                                    <tr>
                                        ...
                                        <td><span
                                                style="font-size: 13px;font-size: 13px;background: white;color: black;border: 1px solid #6975b6;border-radius: 0px;padding: 5px;"
                                                class="badge badge-success"><?php echo $tr['durum'] ?></td>
                                        </span>
                                        ...
                                        <td>
                                            ...
                                            <a href="yeni-siparisler?temizle=<?php echo $tr['id']; ?>"
