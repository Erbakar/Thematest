...
if ($page['idurum'] == '1') {
    if ($page['kdv'] > '0') {
        ...
        $eskifiyat = fiyatgoster($page['fiyat']);
        $yenifiyat = fiyatgoster($page['ifiyat']);
    }
} else {
    if ($page['kdv'] > '0') {
        $yenifiyat = fiyatgoster(KdvDahil($page['fiyat'], $page['kdv']));
    } else {
        $yenifiyat = fiyatgoster($page['fiyat']);
    }
}
                ...
                <div class="row">
                                ...
                                <div id="product-zoom-gallery" class="product-image-gallery">
                                    ...
                                    foreach ($sayfaresimi as $genelresim) { ?>
                                        <a class="product-gallery-item"
                                            ...
                                            <img class="lazyload"
                                                data-src="resimler/urunler/<?php echo $genelresim['sayfaresim']; ?>">
                                        </a>
                                    <?php } ?>
                    ...
                    <div class="col-md-6" style="border: 1px solid #fbf8f8;padding-top: 20px;padding-left: 10px;">
                        <div class="product-details">
                            ...
                            <?php 
                            // data-price için ham sayısal değer (JavaScript parse için)
                            $hamfiyat = ($page['idurum'] == '1') ? KdvDahil($page['ifiyat'], $page['kdv']) : (($page['kdv'] > '0') ? KdvDahil($page['fiyat'], $page['kdv']) : $page['fiyat']);
                            ?>
                            <div id="detayfiyat" data-price="<?php echo $hamfiyat; ?>"
                                class="product-price">
                            ...
                            <?php if ($page['havaledurum'] == '1') { ?>
                                ...
                                <?php } else { ?>
                                    <?php echo $hfiyat = fiyatgoster($page['hfiyat']); ?>
                                <?php } ?>
                            <?php } ?>
                        ...
                        <div class="product-body">
                            ...
                            <div class="product-price">
                                <?php if ($katurunler['idurum'] == '1') { ?>
                                    ...
                                    <?php } else { ?>
                                        <span
                                            class="old-price"><?php echo fiyatgoster($katurunler['fiyat']); ?></span>&nbsp;&nbsp;
                                        <?php echo fiyatgoster($katurunler['ifiyat']); ?>
                                    <?php } ?>
                                ...
                                <?php } else { ?>
                                    ...
                                    <?php } else { ?>
                                        <?php echo fiyatgoster($katurunler['fiyat']); ?>
