...
// Ürün resimleri için resimler/urunler, diğerleri için resimler/genel kullan
$folder_name = ($alanx == 'urunler') ? '../resimler/urunler/' : '../resimler/genel/';
    ...
    <div class="row">
        <?php foreach ($tresimler as $abc) { ?>
            <div class="col-md-1" style="width:20%;margin-right:-25px;">
                <img src="../<?php echo ($alanx == 'urunler') ? 'resimler/urunler/' : 'resimler/genel/'; ?><?php echo $abc['sayfaresim']; ?>" class="img-thumbnail" style="height:75px;width:75px;" />
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Ürün resimleri için resimler/urunler, diğerleri için resimler/genel kullan
    $folder_name = ($alan == 'urunler') ? '../resimler/urunler/' : '../resimler/genel/';
