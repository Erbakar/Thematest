...
<?php
// Soft klasörü için path düzeltmeleri - ana dizindeki func klasörüne erişim
...
var fr_text = { "tr" : "<?php echo $ayar['dtitle'] ?? "";?>" ,"en" : <?php echo $ayar['dtitle'] ?? "";?> , "ar" : "{{TEXT_AR}}" , "ru" : "{{TEXT_RU}}"};
