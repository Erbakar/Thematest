...
<script>
  // Show full story names on hover via native tooltip
  (function addHoverTooltips() {
    function applyTitles() {
      var nameEls = document.querySelectorAll('#stories .name, #stories .title');
    ...
    if (document.readyState === 'loading') {
      document.addEventListener('DOMContentLoaded', function() {
        // Delay to ensure Zuck has rendered items
    ...
    // Apply again shortly after in case of async rendering
