...
<meta property="og:description" content="<?php echo $ayar['sitedesc']; ?>"/>
		   ...
		   <main class="main">
        	<div class="page-header text-center" style="background-image: url('<?php echo $sitetemasi;?>/assets/images/page-header-bg.jpg')">
        		<div class="container">
        			<h1 class="page-title">Ürün Karşılaştırma<span>Anasayfa</span></h1>
        		</div><!-- End .container -->
        	</div><!-- End .page-header -->
            <nav aria-label="breadcrumb" class="breadcrumb-nav">
                <div class="container">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Ürün Karşılaştırma</li>
                    </ol>
                </div><!-- End .container -->
...
<table>
  ...
  <tr>
	...
	<?php } else { ?>
	<?php echo fiyatgoster($karsilastirma['ifiyat']);?>
	<?php } ?>							
	<?php } else { ?>
	<?php if($karsilastirma['kdv']>'0'){?>
    <?php echo fiyatgoster(KdvDahil($karsilastirma['fiyat'],$karsilastirma['kdv']));?>						   
	<?php } else { ?>
	<?php echo fiyatgoster($karsilastirma['fiyat']);?>						    
	<?php } ?>							
	<?php } ?>
   ...
   <tr>
	...
	foreach ($uyesepeti1 as $karsilastirma) {?>
	<td><span>
    <a href="urun/<?php echo $karsilastirma['seo']; ?>" class="btn-product btn-cart" title="Ürünü İncele"><span>Ürünü İncele</span></a>
