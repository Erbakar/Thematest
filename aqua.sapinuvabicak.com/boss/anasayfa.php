...
<head>
	...
	<script src="assets/js/jquery.slimscroll.js?v=<?php echo time(); ?>"></script>
	<script src="assets/js/waves.min.js"></script>
	<script src="assets/pages/dashboard.init.js"></script>
	<link href="assets/toastr/toastr.css" rel="stylesheet" />
	<script src="assets/toastr/toastr.min.js"></script>

	<!-- XML Notification Checker -->
	<script src="assets/js/xml_notification_checker.js?v=<?php echo time() + rand(1000, 9999); ?>"></script>
...
<body>
	...
	// RAM Optimizasyonu: fetchAll yerine direkt DELETE sorgusu kullanarak bellek kullanımını azaltıyoruz
	$sepettemizle = $ozy->prepare("DELETE FROM sepet WHERE DATE(STR_TO_DATE(tarih, '%d.%m.%Y %H:%i:%s')) <= DATE_SUB(CURDATE(), INTERVAL 2 DAY)");
	$sepettemizle->execute();
	...
	// RAM Optimizasyonu: fetchAll yerine direkt DELETE sorgusu kullanarak bellek kullanımını azaltıyoruz
	$ksepettemizle = $ozy->prepare("DELETE FROM karsilastir WHERE DATE(STR_TO_DATE(tarih, '%d.%m.%Y %H:%i:%s')) <= DATE_SUB(CURDATE(), INTERVAL 2 DAY)");
	$ksepettemizle->execute();
