						 ...
						 <?php } ?>
                           ...
                           foreach ($pr as $tr) {?>	
                                ...
                                <td><?php echo $tr['adi']?></td>
			                        ...
			                        <a href="anasayfa.php?trendmaxtrs=sayfa-ekle&duzenle=<?php echo $tr['id']?>" class="btn btn-sm btn-success" data-toggle="tooltip" data-original-title="Düzenle"><i class="fa fa-edit" aria-hidden="true"></i></a>					
