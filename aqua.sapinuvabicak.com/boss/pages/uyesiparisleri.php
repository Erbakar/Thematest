        ...
        <div class="container-fluid">
            ...
            <div class="page-title-box">
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <h4 class="page-title">Üye Siparişler</h4>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-right">
                            <li class="breadcrumb-item"><a href="index.html">Anasayfa</a></li>
                           
                            <li class="breadcrumb-item active">Üye Siparişler</li>
                        </ol>
                    </div>
                </div>
                <!-- end row -->
                ...
                <div class="col-12">
                    <div class="card m-b-30">
                        <div class="card-body">
	                       ...
	                       <?php $pr = $ozy->query("select * from siparis where uye='{$uyeid}' ORDER BY id desc")->fetchAll(PDO::FETCH_ASSOC);
                           foreach ($pr as $tr) {?>	
                                ...
                                <tr>
								 <td><?php echo $tr['id']?></td>
			                        ...
			                        <a href="uye-siparisleri?temizle=<?php echo $tr['id'];  ?>" onclick="return confirm('Silmek istediğinize emin misiniz ?')" class="btn btn-sm btn-danger" data-toggle="tooltip" data-original-title="Sil"><i class="ti-trash" aria-hidden="true"></i></a>									 
