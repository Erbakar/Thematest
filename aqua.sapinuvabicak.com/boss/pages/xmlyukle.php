...
<script>
    $("#kaydet").click(function(e) {
        ...
        formData += '&kaydet=1'; // Kaydet değerini manuel olarak ekle
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.status === 'processing') {
                    ...
                    // Eğer redirect bilgisi varsa yönlendir
    ...
    function startXmlProcess(xmlId) {
        // Progress popup'ı aç
        var progressWindow = window.open("/boss/pages/xml_progress_show.php", "_blank", "width=400,height=200");
