        ...
        <div class="container-fluid">
            ...
            <div class="page-title-box">
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <h4 class="page-title">Tüm Hediye Çekleri</h4>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-right">
                            <li class="breadcrumb-item"><a href="index.html">Anasayfa</a></li>
                           
                            <li class="breadcrumb-item active">Hediye Çekleri</li>
                        </ol>
                    </div>
                </div>
                <!-- end row -->
                ...
                <div class="col-12">
                    <div class="card m-b-30">
                        <div class="card-body">
							...
							<a href="hediyeceki-ekle" style="width: 100%;" class="btn btn-success waves-effect waves-lightt">
							Hediye Çeki Ekle
							</a>
                            ...
                            <table id="datatable" data-order='[[ 0, "desc" ]]'  class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                <thead>
                                <tr>
                                    <th>Hediye Çeki Kodu</th>
                                    <th>Hediye Çeki Tipi</th>
	                       ...
	                       <?php $pr = $ozy->query("select * from kuponlar where sekil='1' ORDER BY id DESC")->fetchAll(PDO::FETCH_ASSOC);
                           foreach ($pr as $tr) {?>	
                                ...
                                <tr>
									...
									<a href="tum-hediyecekleri?temizle=<?php echo $tr['id'];  ?>" onclick="return confirm('Silmek istediğinize emin misiniz ?')" class="btn btn-sm btn-danger" data-toggle="tooltip" data-original-title="Sil"><i class="ti-trash" aria-hidden="true"></i></a>									 
			                        <a href="hediyeceki/duzenle/<?php echo $tr['id']?>" class="btn btn-sm btn-success" data-toggle="tooltip" data-original-title="Düzenle"><i class="fa fa-edit" aria-hidden="true"></i></a>					
